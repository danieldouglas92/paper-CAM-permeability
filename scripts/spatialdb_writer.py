...
# def write_spatialdb_file(vertices, rupture_times, left_lateral_slips, opening_slips, filename, dimension=2):
#     '''
...
#                   'coordsys': cs,
#                   'data_dim': 1,
#                   'values': [{'name': "initiation_time",
#                               'units': "year",
#                               'data': rupture_times},
#                              {'name': "final_slip_left_lateral",
#                               'units': "m",
#                               'data': left_lateral_slips},
...
# def write_spatialgrid_file(vertices, x_length, y_length, z_length=0, field_names, field_units, field_data, filename, dimension=2):
#     '''
#     Writes the spatialDB file. vertices is an nxdimension array containing the spatial coordinates of the spatialDB file.
#     rupture_times, left_lateral_slips, opening_angles correspond to when the fault will rupture, how much it will slip,
#     and how much it will open, respectively. filename is the name of the spatialDB file.
